...
Скопируйте всё целиком и вставьте в чат Claude Code:
...
> Этот промпт вставляется один раз. Claude Code сам определит версию Python, обойдёт SSL ошибки, проверит файлы и сообщит о результате.
