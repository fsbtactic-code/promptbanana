...
Вставьте в терминал Claude Code и нажмите Enter:
...
Скрипт сам:
- Скачает файлы с GitHub (без git)
- Установит зависимости через pip
- Соберёт базу знаний
- Установит команды `/promptbnn_*` глобально — доступны из любого проекта
